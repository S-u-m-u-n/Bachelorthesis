...
if args.precision == 32:
    ...
    if args.M == 1024 and args.N == 1024 and args.K == 1024:
        ...
        # schedule = Schedule(load_k=8, thread_tile_m=8, thread_tile_n=4, warp_tile_m=32, warp_tile_n=32, thread_block_tile_m=32, thread_block_tile_n=128) # 1.8ms, correct
        schedule = Schedule(load_k=8, thread_tile_m=8, thread_tile_n=8, warp_tile_m=64, warp_tile_n=32, thread_block_tile_m=64, thread_block_tile_n=128) # 1.8ms
    ...
    if args.M == 1024 and args.N == 1024 and args.K == 1024:
        ...
        schedule = Schedule(load_k=8, thread_tile_m=8, thread_tile_n=4, warp_tile_m=16, warp_tile_n=16, thread_block_tile_m=32, thread_block_tile_n=128) # 24.455ms
