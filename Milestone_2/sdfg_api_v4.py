...
if args.precision == 32:
    ...
    if args.M == 1024 and args.N == 1024 and args.K == 1024:
        ...
        # schedule = Schedule(load_k=8, thread_tile_m=8, thread_tile_n=4, warp_tile_m=16, warp_tile_n=32, thread_block_tile_m=64, thread_block_tile_n=64) # Only uses 16 threads/warp, still fastest
        schedule = Schedule(load_k=8, thread_tile_m=8, thread_tile_n=4, warp_tile_m=16, warp_tile_n=16, thread_block_tile_m=64, thread_block_tile_n=64)
