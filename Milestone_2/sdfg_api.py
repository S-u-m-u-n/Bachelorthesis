...
thread_tile_map_entry, thread_tile_map_exit = nested_state.add_map(
        'Thread_tile',
        dict(thread_tile_i='warp_i*size_warp_tile_m:warp_i*size_warp_tile_m+size_warp_tile_m:size_thread_tile_m', thread_tile_j='warp_j*size_warp_tile_n:warp_j*size_warp_tile_n+size_warp_tile_n:size_thread_tile_n'),
        schedule=dace.dtypes.ScheduleType.Default)
...
map_entry, map_exit = nested_state.add_map(
        'matmul_map',
        dict(i='thread_tile_i*size_thread_tile_m:thread_tile_i*size_thread_tile_m+size_thread_tile_m', j='thread_tile_j*size_thread_tile_n:thread_tile_j*size_thread_tile_n+size_thread_tile_n', k='k_tile:k_tile+size_thread_tile_k'),
        schedule=dace.dtypes.ScheduleType.Default)
