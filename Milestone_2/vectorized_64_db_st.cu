                      ...
                      for (auto k = 0; k < size_K_tile; k += 1) {
                        ...
                        dace::CopyND<double, 1, false, size_thread_tile_m>::
                            template ConstDst<1>::Copy(
                                shared_memory_A +
                                    (((k +
                                       ((8 * size_thread_tile_m) *
                                        bitwise_and(
                                            right_shift((((thread_j %
                                                           size_warp_tile_n) /
                                                          size_thread_tile_n) +
                                                         ((warp_width *
                                                           (thread_i %
...
#pragma unroll
              ...
              dace::CopyND<double, 1, false, size_thread_tile_m,
                  ...
                  Accumulate(
                      register_storage_C,
                      output +
                          ((((N * ((((-size_thread_tile_m) *
                                     bitwise_and(right_shift(0, 1),
                                                 (warp_height - 1))) +
                                    (size_thread_tile_m *
                                     bitwise_and(
                                         right_shift(
                             ...
                             bitwise_or(
                                 right_shift(
                                     bitwise_and(
                                         ...
                                         ((warp_height * warp_width) / 2)),
                                     (warp_width - 1)),
                                 bitwise_and((((thread_j % size_warp_tile_n) /
                                               size_thread_tile_n) +
                                              ((warp_width *
                                                (thread_i % size_warp_tile_m)) /
                                               size_thread_tile_m)),
                                             1)))) +
                           (size_warp_tile_n * (thread_j / size_warp_tile_n))),
      ...
      nested_nested_state_1_1_5(
          ...
          &output[(
              ((N * ((size_thread_block_tile_m * thread_block_i) +
                     (size_thread_tile_m *
                      bitwise_and(right_shift(0, 1), (warp_height - 1))))) +
               (size_thread_block_tile_n * thread_block_j)) +
              (size_thread_tile_n *
               bitwise_or(
                   right_shift(bitwise_and(0, ((warp_height * warp_width) / 2)),
                               (warp_width - 1)),
                   bitwise_and(0, 1))))],
          K, M, N);
    }
