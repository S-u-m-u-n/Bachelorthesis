...
def print_device_info(device, colorless = False):
    if colorless:
        ...
        print(">> total_cuda_cores:", device.total_cuda_cores)
        print(">> cuda_capability_version:", device.cuda_capability_version)
        print("======================================")
    else:
        ...
        print("\033[01m\033[36m>> total_cuda_cores:\033[0m", device.total_cuda_cores)
        print("\033[01m\033[36m>> cuda_capability_version:\033[0m", device.cuda_capability_version)
