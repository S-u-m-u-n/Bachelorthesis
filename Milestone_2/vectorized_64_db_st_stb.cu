...
DACE_DFI void nested_nested_state_1_1_5(const dace::vec<double, 2> * input_A, const dace::vec<double, 2> * input_B, double * output, int K, int M, int N) {
    constexpr long long VECLEN = 2;
    constexpr double alpha = 1;
    constexpr double beta = 1;
    constexpr long long size_thread_block_tile_m = 128;
    ...
    for (k_tile = 0; (k_tile < (num_K_tiles - 1)); k_tile = k_tile + 1) {
        {
            ...
            #pragma omp parallel sections
            {
                                                        ...
                                                        for (auto j = 0; j < size_thread_tile_n; j += 1) {
                                                            {
                                                                ...
                                                                dace::wcr_fixed<dace::ReductionType::Sum, double>::reduce(register_storage_C + ((8 * i) + j), __out);
                                                            }
                                                        }
                                                    }
                                                }
                ...
                #pragma omp section
                {
                    dace::GlobalToShared2D<dace::vec<double, 2>, max(1, int_ceil(size_thread_block_tile_n, size_thread_tile_n)), max(1, int_ceil(size_thread_block_tile_m, size_thread_tile_m)), 1, size_thread_block_tile_m, size_K_tile / 2, 8 / 2, 1, true>(input_A + (size_K_tile * (k_tile + 1)) / 2, K / 2, 1, ((dace::vec<double, 2> *) shared_memory_A) + (1024 * ((k_tile + 1) % 2)) / 2);
                } // End omp section
                #pragma omp section
                {
                    dace::GlobalToShared2D<dace::vec<double, 2>, max(1, int_ceil(size_thread_block_tile_n, size_thread_tile_n)), max(1, int_ceil(size_thread_block_tile_m, size_thread_tile_m)), 1, size_K_tile, size_thread_block_tile_n / 2, 64 / 2, 1, true>(input_B + ((N * size_K_tile) * (k_tile + 1)) / 2, N / 2, 1, ((dace::vec<double, 2> *) shared_memory_B) + (512 * ((k_tile + 1) % 2)) / 2);
                } // End omp section
            } // End omp sections
...
__global__ void initialize_matmul_result_1_0_1(double * __restrict__ output, int M, int N) {
    constexpr long long VECLEN = 2;
    constexpr long long size_thread_block_tile_m = 128;
    constexpr long long size_thread_block_tile_n = 64;
    constexpr long long num_thread_blocks_m = 16;
...
DACE_EXPORTED void __dace_runkernel_initialize_matmul_result_1_0_1(gemm_t *__state, double * __restrict__ output, int M, int N);
void __dace_runkernel_initialize_matmul_result_1_0_1(gemm_t *__state, double * __restrict__ output, int M, int N)
{
...
__global__ void Thread_block_grid_1_1_3(const dace::vec<double, 2> * __restrict__ input_A, const dace::vec<double, 2> * __restrict__ input_B, double * __restrict__ output, int K, int M, int N) {
    constexpr long long VECLEN = 2;
    constexpr long long size_thread_block_tile_m = 128;
    constexpr long long size_thread_block_tile_n = 64;
    constexpr long long num_thread_blocks_m = 16;
...
DACE_EXPORTED void __dace_runkernel_Thread_block_grid_1_1_3(gemm_t *__state, const double * __restrict__ input_A, const double * __restrict__ input_B, double * __restrict__ output, int K, int M, int N);
void __dace_runkernel_Thread_block_grid_1_1_3(gemm_t *__state, const double * __restrict__ input_A, const double * __restrict__ input_B, double * __restrict__ output, int K, int M, int N)
{
...
__global__ void multiply_matrix_with_constant_0_0_14(const double * __restrict__ A_matmul_B, double * __restrict__ A_matmul_B_times_alpha, int M, int N) {
    constexpr long long VECLEN = 2;
    constexpr double alpha = 1;
    constexpr double beta = 1;
    constexpr long long size_thread_block_tile_m = 128;
...
DACE_EXPORTED void __dace_runkernel_multiply_matrix_with_constant_0_0_14(gemm_t *__state, const double * __restrict__ A_matmul_B, double * __restrict__ A_matmul_B_times_alpha, int M, int N);
void __dace_runkernel_multiply_matrix_with_constant_0_0_14(gemm_t *__state, const double * __restrict__ A_matmul_B, double * __restrict__ A_matmul_B_times_alpha, int M, int N)
{
...
__global__ void multiply_matrix_with_constant_0_0_11(double * __restrict__ C_times_beta, const double * __restrict__ gpu_C, int M, int N) {
    constexpr long long VECLEN = 2;
    constexpr double alpha = 1;
    constexpr double beta = 1;
    constexpr long long size_thread_block_tile_m = 128;
...
DACE_EXPORTED void __dace_runkernel_multiply_matrix_with_constant_0_0_11(gemm_t *__state, double * __restrict__ C_times_beta, const double * __restrict__ gpu_C, int M, int N);
void __dace_runkernel_multiply_matrix_with_constant_0_0_11(gemm_t *__state, double * __restrict__ C_times_beta, const double * __restrict__ gpu_C, int M, int N)
{
...
__global__ void add_matrices_0_0_17(const double * __restrict__ A_matmul_B_times_alpha, const double * __restrict__ C_times_beta, double * __restrict__ gpu_result, int M, int N) {
    constexpr long long VECLEN = 2;
    constexpr double alpha = 1;
    constexpr double beta = 1;
    constexpr long long size_thread_block_tile_m = 128;
...
DACE_EXPORTED void __dace_runkernel_add_matrices_0_0_17(gemm_t *__state, const double * __restrict__ A_matmul_B_times_alpha, const double * __restrict__ C_times_beta, double * __restrict__ gpu_result, int M, int N);
void __dace_runkernel_add_matrices_0_0_17(gemm_t *__state, const double * __restrict__ A_matmul_B_times_alpha, const double * __restrict__ C_times_beta, double * __restrict__ gpu_result, int M, int N)
{
