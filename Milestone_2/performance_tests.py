...
helpers.print_info("=" * 20, False)
subprocess.run(["python", "./cosma.py", "-M=1024", "-N=1024", "-K=1024", "--quiet", "--version=unoptimized", "--skip_verification"])
subprocess.run(["python", "./cosma.py", "-M=1024", "-N=1024", "-K=1024", "--quiet", "--version=optimize_gpu", "--skip_verification"])
subprocess.run(["python", "./cosma.py", "-M=1024", "-N=1024", "-K=1024", "--quiet", "--version=cublas", "--skip_verification"])
...
subprocess.run(["nvprof", "python", "./cosma.py", "-M=4096", "-N=4096", "-K=4096", "--quiet", "--version=optimize_gpu", "--skip_verification"])
...
subprocess.run(["nvprof", "python", "./cosma.py", "-M=1024", "-N=1024", "-K=8192", "--quiet", "--version=optimize_gpu", "--skip_verification"])
