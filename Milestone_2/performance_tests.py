...
if args.test == 1:
    ...
    subprocess.run(["nvprof", "--print-gpu-trace", "--csv", "--log-file", "./performance_test_results/1024_1024/" + str(args.path) + "/swizzled_threads_swizzled_thread_blocks.csv", "python", "./sdfg_api.py", "-M=1024", "-N=1024", "-K=1024", "--swizzle-thread-blocks", "--repetitions=" + str(args.repetitions)])
    ...
    subprocess.run(["nvprof", "--print-gpu-trace", "--csv", "--log-file", "./performance_test_results/1024_1024/" + str(args.path) + "/vectorization_swizzled_thread_blocks.csv", "python", "./sdfg_api.py", "-M=1024", "-N=1024", "-K=1024", "--vectorization", "--swizzle-threads", "--repetitions=" + str(args.repetitions)])
    subprocess.run(["nvprof", "--print-gpu-trace", "--csv", "--log-file", "./performance_test_results/1024_1024/" + str(args.path) + "/vectorization_swizzled_threads_swizzled_thread_blocks.csv", "python", "./sdfg_api.py", "-M=1024", "-N=1024", "-K=1024", "--swizzle-thread-blocks", "--repetitions=" + str(args.repetitions)])
