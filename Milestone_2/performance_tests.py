...
subprocess.run(["nvprof", "--print-gpu-trace", "--csv", "--log-file", "1024_1024_optimized.csv", "python", "./cosma.py", "-M=1024", "-N=1024", "-K=1024", "--quiet", "--version=dace", "--skip-verification", "--gpu-type=default", "--repetitions=5"])
subprocess.run(["nvprof", "--print-gpu-trace", "--csv", "--log-file", "1024_1024_cublas.csv", "python", "./cosma.py", "-M=1024", "-N=1024", "-K=1024", "--quiet", "--version=cublas", "--skip-verification", "--gpu-type=default", "--repetitions=5"])
...
subprocess.run(["nvprof", "--print-gpu-trace", "--csv", "--log-file", "4096_4096_cublas.csv", "python", "./cosma.py", "-M=4096", "-N=4096", "-K=4096", "--quiet", "--version=cublas", "--skip-verification", "--gpu-type=default", "--repetitions=5"])
...
subprocess.run(["nvprof", "--print-gpu-trace", "--csv", "--log-file", "1024_8192_8192_1024_cublas.csv", "python", "./cosma.py", "-M=1024", "-N=1024", "-K=8192", "--quiet", "--version=cublas", "--skip-verification", "--gpu-type=default", "--repetitions=5"])