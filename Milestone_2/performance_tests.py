...
if args.test == 1:
    ...
    subprocess.run(["nvprof", "--print-gpu-trace", "--csv", "--log-file", "./performance_test_results/1024_1024/cutlass.csv", "/home/jacobsi", "--verification-enabled=false", "--warmup-iterations=0" "--operation=Gemm", "--m=1024", "--n=1024", "--k=1024", "--cta_m=128", "--cta_n=64", "--A=f64:column", "--B=f64:column", "--profiling-iterations=" + str(args.repetitions - 1)])
...
if args.test == 2:
    ...
    subprocess.run(["nvprof", "--print-gpu-trace", "--csv", "--log-file", "./performance_test_results/4096_4096/cutlass.csv", "/home/jacobsi", "--verification-enabled=false", "--warmup-iterations=0" "--operation=Gemm", "--m=4096", "--n=4096", "--k=4096", "--cta_m=128", "--cta_n=64", "--A=f64:column", "--B=f64:column", "--profiling-iterations=" + str(args.repetitions - 1)])
