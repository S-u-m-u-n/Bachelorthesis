...
if args.test == 2:
    ...
    # # subprocess.run(nvprof_options + ["./performance_test_results/4096_4096/" + str(args.path) + "/swizzled_thread_blocks.csv", "python", "./sdfg_api.py", "-M=4096", "-N=4096", "-K=4096", "--swizzle-thread-blocks", "2"])
    ...
    subprocess.run(nvprof_options + ["./performance_test_results/4096_4096/" + str(args.path) + "/swizzled_threads.csv", "python", "./sdfg_api.py", "-M=4096", "-N=4096", "-K=4096", "--swizzle-threads"])
    subprocess.run(nvprof_options + ["./performance_test_results/4096_4096/" + str(args.path) + "/swizzled_thread_blocks.csv", "python", "./sdfg_api.py", "-M=4096", "-N=4096", "-K=4096", "--swizzle-thread-blocks", "2"])
    subprocess.run(nvprof_options + ["./performance_test_results/4096_4096/" + str(args.path) + "/swizzled_threads_swizzled_thread_blocks.csv", "python", "./sdfg_api.py", "-M=4096", "-N=4096", "-K=4096", "--swizzle-threads", "--swizzle-thread-blocks", "2"])
    subprocess.run(nvprof_options + ["./performance_test_results/4096_4096/" + str(args.path) + "/vectorization_swizzled_threads.csv", "python", "./sdfg_api.py", "-M=4096", "-N=4096", "-K=4096", "--vectorization", "--swizzle-threads"])
    subprocess.run(nvprof_options + ["./performance_test_results/4096_4096/" + str(args.path) + "/vectorization_swizzled_thread_blocks.csv", "python", "./sdfg_api.py", "-M=4096", "-N=4096", "-K=4096", "--vectorization", "--swizzle-thread-blocks", "2"])
    subprocess.run(nvprof_options + ["./performance_test_results/4096_4096/" + str(args.path) + "/vectorization_swizzled_threads_swizzled_thread_blocks.csv", "python", "./sdfg_api.py", "-M=4096", "-N=4096", "-K=4096", "--vectorization", "--swizzle-threads", "--swizzle-thread-blocks", "2"])
    subprocess.run(nvprof_options + ["./performance_test_results/4096_4096/" + str(args.path) + "/double_buffering.csv", "python", "./sdfg_api.py", "-M=4096", "-N=4096", "-K=4096", "--double-buffering"])
    subprocess.run(nvprof_options + ["./performance_test_results/4096_4096/" + str(args.path) + "/double_buffering_vectorization.csv", "python", "./sdfg_api.py", "-M=4096", "-N=4096", "-K=4096", "--double-buffering", "--vectorization"])
    subprocess.run(nvprof_options + ["./performance_test_results/4096_4096/" + str(args.path) + "/double_buffering_swizzled_threads.csv", "python", "./sdfg_api.py", "-M=4096", "-N=4096", "-K=4096", "--double-buffering", "--swizzle-threads"])
    subprocess.run(nvprof_options + ["./performance_test_results/4096_4096/" + str(args.path) + "/double_buffering_swizzled_thread_blocks.csv", "python", "./sdfg_api.py", "-M=4096", "-N=4096", "-K=4096", "--swizzle-thread-blocks", "2"])
    subprocess.run(nvprof_options + ["./performance_test_results/4096_4096/" + str(args.path) + "/double_buffering_swizzled_threads_swizzled_thread_blocks.csv", "python", "./sdfg_api.py", "-M=4096", "-N=4096", "-K=4096", "--swizzle-threads", "--swizzle-thread-blocks", "2"])
    subprocess.run(nvprof_options + ["./performance_test_results/4096_4096/" + str(args.path) + "/double_buffering_vectorization_swizzled_threads.csv", "python", "./sdfg_api.py", "-M=4096", "-N=4096", "-K=4096", "--double-buffering", "--vectorization", "--swizzle-threads"])
    subprocess.run(nvprof_options + ["./performance_test_results/4096_4096/" + str(args.path) + "/double_buffering_vectorization_swizzled_thread_blocks.csv", "python", "./sdfg_api.py", "-M=4096", "-N=4096", "-K=4096", "--double-buffering", "--vectorization", "--swizzle-thread-blocks", "2"])
    subprocess.run(nvprof_options + ["./performance_test_results/4096_4096/" + str(args.path) + "/double_buffering_vectorization_swizzled_threads_swizzled_thread_blocks.csv", "python", "./sdfg_api.py", "-M=4096", "-N=4096", "-K=4096", "--double-buffering", "--vectorization", "--swizzle-threads", "--swizzle-thread-blocks", "2"])
