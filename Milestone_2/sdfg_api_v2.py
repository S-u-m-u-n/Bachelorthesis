...
if args.precision == 32:
    ...
    ndtype = np.float32
    veclen = 4
    schedule = Schedule(load_k=8, thread_tile_m=8, thread_tile_n=8, thread_tile_k=8, warp_tile_m=64, warp_tile_n=32, thread_block_tile_m=128, thread_block_tile_n=32)
