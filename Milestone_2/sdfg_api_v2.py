...
if args.split_k > 1:
    ...
    nested_sdfg.add_transient('accumulator', shape=[8, 8], dtype=dace.float64, storage=dace.StorageType.Register) # TODO: what size should this local storage be?? Doesn't seem to have an effect on performance now.
