...
sdfg.add_constant('num_K_tiles', K_example // schedule.load_k)
...
sdfg.add_constant('SPLIT_K', math.ceil(K_example / args.split_k))
...
nested_sdfg.add_constant('size_K_split', K_example // args.split_k)
nested_sdfg.add_constant('SWIZZLE', args.swizzle_thread_blocks)
nested_sdfg.add_constant('SPLIT_K', math.ceil(K_example / args.split_k))
